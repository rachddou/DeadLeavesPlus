#!/bin/bash
#SBATCH --job-name=train_inpaint_VL_h100            # nom du job
...
#SBATCH --time=19:50:00                      # temps maximum d'execution demande (HH:MM:SS)
...
python3 launcher_train_inpaint.py \
    --train_dir    $DATASETS/vibrant_leaves_sinusoids_bis \
